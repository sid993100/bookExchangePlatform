...
// DELETE FROM users_books WHERE users_books.bookisbn = (SELECT isbn FROM books WHERE title = 'chamber of secrets') AND users_books.requester = (SELECT user_id FROM users WHERE username = 'username')
